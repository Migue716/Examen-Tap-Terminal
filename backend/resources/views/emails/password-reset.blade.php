            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                ...
                <tr>
                    <td style="background-color:#ffffff;padding:36px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
                        ...
                        <h2 style="margin:0 0 20px;font-size:20px;font-weight:700;color:#0f172a;letter-spacing:-0.02em;">Hola, {{ $userName }}</h2>
                                    ...
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding-bottom:20px;border-bottom:1px solid #e2e8f0;">
                                                ...
                                                <p style="margin:0;font-size:16px;font-weight:600;color:#0f172a;">{{ $username }}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-top:20px;">
                                                ...
                                                <p style="margin:0;font-size:18px;font-weight:700;color:#0369a1;font-family:Consolas,'Courier New',monospace;letter-spacing:0.04em;word-break:break-all;">{{ $temporaryPassword }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="padding-bottom:8px;">
                                    <a href="{{ config('app.frontend_url', 'http://localhost:4200') }}/login"
                ...
                <tr>
                    <td style="background-color:#f8fafc;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 16px 16px;padding:24px 36px;text-align:center;">
                        ...
                        <p style="margin:0;font-size:11px;color:#94a3b8;">
                            &copy; {{ date('Y') }} Tap Terminal · Mensaje automático, no responder.
                        </p>
                    </td>
                </tr>
            </table>
